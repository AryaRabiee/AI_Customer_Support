...
@tool
def order_status_tool(order_id , user_id: Annotated[int, InjectedState("user_id")]):
    """Get status of a customer's order by order ID."""
    logger.info("tool called order_status_tool")
